<%@ include file="/header.jsp" %>
	<form>
		<fieldset>
			<legend>&nbsp;Lista de clientes:<a class="linkMais" href="<c:url value="/clientes/formulario"/>"><img class="btnMais" alt="mais" title="mais" src="<c:url value="/images/mais.png"/>" /></a></legend>
