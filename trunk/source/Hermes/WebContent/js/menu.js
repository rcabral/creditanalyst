...
function temas(tema) {
  switch(tema) {
       case 0 : //cinza
		   cor_Menu_Ativa = '#fff';
		   cor_Menu_NaoAtiva = '#ccc'; 
		   cor_Fonte_Menu_Ativa = '#000';
		   cor_Fonte_Menu_NaoAtiva = '#009';
		   cor_Submenu_Ativa = '#fff';
		   cor_Submenu_NaoAtiva = '#ccc';
		   cor_Fonte_Submenu_Ativa = '#000';
		   cor_Fonte_Submenu_NaoAtiva = '#009';
           break
       case 1 : //preto
      ...
      case 9 : // naval
       ...
       case 14 : // metálico
           ...
           if(moz || nav == 'Opera') {
               ...
               document.styleSheets[0].cssRules[2].style.backgroundImage = 'url(../images/fundo_01.jpg)';
               ...
               document.styleSheets[0].rules[2].style.backgroundImage = 'url(../images/fundo_01.jpg)';
       ...
       case 15 : // menu vista
           ...
           if(moz || nav == 'Opera') {
               ...
               document.styleSheets[0].cssRules[2].style.backgroundColor = '#FFFFFF'; 
               document.styleSheets[0].cssRules[2].style.border = 'none'; 	   	   
               document.styleSheets[0].cssRules[2].style.backgroundImage = 'url(../images/round10a.gif)';
	           document.styleSheets[0].cssRules[2].style.backgroundRepeat = 'repeat-x';
		   }
		   else {
               ...
               document.styleSheets[0].rules[2].style.backgroundColor = '#FFFFFF'; 
               document.styleSheets[0].rules[2].style.border = 'none'; 	   	   
               document.styleSheets[0].rules[2].style.backgroundImage = 'url(../images/round10a.gif)';
	           document.styleSheets[0].rules[2].style.backgroundRepeat = 'repeat-x';
		   }			   
           break
       default : //branco
